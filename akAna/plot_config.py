...
config = {
    ...
    'pfRelIso'    : pcfg(      0,   0.25, 100, False, False, 'pfRelIso'),
    'pfvaId'      : pcfg(   19.9,     20, 100, False, False, 'pfvaId'),
    'trkRelIso'   : pcfg(      0,     20, 100, False, False, 'trkRelIso'),
    'vx'          : pcfg(   -0.5,    0.5, 100, False, False, 'vx'),
    'vy'          : pcfg(   -0.5,    0.5, 100, False, False, 'vy'),
