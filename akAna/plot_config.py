...
config = {
    ...
    'eta'         : pcfg(     -3,      3,  40, False, False, 'eta'),
    'phi'         : pcfg(-3.1415, 3.1415,  40, False, False, 'phi'),
    'mass'        : pcfg( -0.001,  0.001,  40, False, False, 'mass'),
    'dxy'         : pcfg(   -0.2,    0.2,  40, False, False, 'dxy [mm]'),
    'dxyErr'      : pcfg(      0,      2,  40,  True, False, 'dxy Error [mm]'),
    'dz'          : pcfg(    -15,     15,  40, False, False, 'dz [mm]'),
    'dzErr'       : pcfg(      0,      2,  40,  True, False, 'dz Error [mm]'),
    ...
    'sip3d'       : pcfg(      0,   2000, 100, False, False, 'sip3d'),
